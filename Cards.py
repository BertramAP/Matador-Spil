...
def generate_spaces(bot_batch, top_batch):
    ...
    Spaces = [start(),street('Rødovrevej', [0, 0, 255], 1200, [50, 250, 750, 2250, 4000, 6000]), Chance(), street('Hvidovrevej', [0, 0, 255], 1200, [50, 250, 750, 2250, 4000, 6000]), 
              payTaxSpace(True), shippingPort('Scandlines, Helsingør-Helsingborg'),street('Roskildevej', [255, 100, 127], 2000, [100, 600, 1800, 5400, 8000, 11000]),
              ...
              prison(True), street('Frederiksberg Alle', [0, 255, 0], 2800, [200, 1000, 3000, 9000, 12500, 15000]), Corparation('Tuborg'), street('Bulowsvej', [0, 255, 0], 2800, [200, 1000, 3000, 9000, 12500, 15000]),
              street('G.L. Kongevej', [0, 255, 0], 3200, [250, 1250, 3750, 10000, 14000, 18000]), shippingPort('Mols-Linien'),street('Bernstorttsvej', [128, 128, 128], 3600, [300, 1400, 4000, 11000, 15000, 19000]),
              Chance(), street('Hellerupvej', [128, 128, 128], 3600, [300, 1400, 4000, 11000, 15000, 19000]), street('Strandvejen', [128, 128, 128], 4000, [350, 1600, 4400, 12000, 16000, 20000]),
              parkingSpace(), street('Trianglen', [255, 51, 51], 4400, [350, 1800, 5000, 14000, 17500, 21000]), Chance(), street('Østerbrogade', [255, 51, 51], 4400, [350, 1800, 5000, 14000, 17500, 21000]),
              street('Grønningen', [255, 51, 51], 4800, [400, 2000, 6000, 15000, 18500, 22000]), shippingPort('Scandlines Gedse-Rostock'), street('Bredgade', [0, 0, 0], 5200, [450, 2200, 6600, 16000, 19500, 23000]),
              street('Kgs. Nytorv', [0, 0, 0], 5200, [450, 2200, 6600, 16000, 19500, 23000]),Corparation('Coca-Cola'),street('Østergade', [0, 0, 0], 5600, [500, 2400, 7200, 17000, 20500, 24000]),
              prison(False), street('Amagertorv', [255, 234, 0], 6000, [550, 2600, 7800, 18000, 22000, 25000]), street('Vimmelskaftet ', [255, 234, 0], 6000, [550, 2600, 7800, 18000, 22000, 25000]), Chance(),
              street('Nygade', [255, 234, 0], 6400, [600, 3000, 9000, 20000, 24000, 28000]), shippingPort('Scandlines, Rødby-Puttgarden'), Chance(), street('Frederiksberggade', [255, 234, 0], 7000, [700, 3500, 10000, 22000, 26000, 30000]),
              payTaxSpace(False), street('Rådhuspladsen', [255, 234, 0], 8000, [1000, 4000, 12000, 28000, 34000, 40000])]
