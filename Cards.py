...
def generate_spaces(bot_batch, top_batch):
    ...
    Spaces = [start(),street('Rødovrevej', [0, 0, 255], 1200, [50, 250, 750, 2250, 4000, 6000]), Chance(), street('Hvidovrevej', [0, 0, 255], 1200, [50, 250, 750, 2250, 4000, 6000]), 
              ...
              prison(), street('Frederiksberg Alle', [0, 255, 0], 2800, [200, 1000, 3000, 9000, 12500, 15000]), Corparation('Tuborg'), street('Bulowsvej', [0, 255, 0], 2800, [200, 1000, 3000, 9000, 12500, 15000]),
              ...
              prison(), street('Amagertorv', [255, 234, 0], 6000, [550, 2600, 7800, 18000, 22000, 25000]), street('Vimmelskaftet ', [255, 234, 0], 6000, [550, 2600, 7800, 18000, 22000, 25000]), Chance(),
